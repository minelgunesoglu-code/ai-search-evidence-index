...
**Çekim:** 30 Ağustos 2026, 20:38:51–20:40:17 UTC · **Araç:** v1.7 (blok bazlı)
**Doğrulama:** yayınlanan her blok elle okundu (89 blok, istisnasız)
...
| tryprofound.com — *best-tools* | 10 | 5 | **%50** | *%59* |
...
| tryprofound.com — *chatgpt-citations* | 17 | 1 | **%6** | *%10* |
| llmrefs.com | 11 | 0 | **%0** | *%0* |
| zapier.com | 10 | 0 | **%0** | *%5* |

**13 sayfa · medyan %33 · aralık %0–%62 · havuz 80/252 = %31,7**

10 bloktan az olan 13 sayfa yüzdesiz bırakıldı.
...
**2. İddia sayımının ölçülmüş hatası: %22.** 50 blok elle kodlandı, 11'i
aslında iddia değildi (tavsiye, biyografi, yazım örneği) — 95% GA %11–%33.
Bunların ~%86'sı kaynaksız bloklarda, yani **yayınlanan oranlar gerçeğin
altındadır.** Düzeltilmiş havuz tahmini ≈ **%39** (%35–%44).

**3. Altı sayfa bot koruması nedeniyle çekilemedi** ve rastgele değiller —
...
Ölçüm birimi değişti (rakam → blok), 11 link elle reddedildi, örneklem iki
